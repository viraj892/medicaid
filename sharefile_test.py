...
atoken = 'NMxbcHOxY8gN1LcCIQFGnxj6TcfLs67K$$RVJCZr4B0ekJFVIuDjLz8JXlYDNa8HW0'
...
username = 'brian.coleman@cumberlandcg.com'
password = 'Ncsuball!1'
...
def upload_item_by_path(token, target_folder, local_file):
    upload_file(token, get_item_by_path(access_token, urlify(target_folder)), local_file)
...
authenticate(hostname, client_id, client_secret, username, password)
