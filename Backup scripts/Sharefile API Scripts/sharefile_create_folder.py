...
def upload_item_by_path(token, src_file, dest_file):
    upload_file(token, src_file, get_item_by_path(token, urlify(dest_file)))
...
create_folder_by_path(access_token, urlify(folder_path), description)

# delete_item_by_path(access_token, src)


"""
{
u'access_files_folders': True,
u'change_my_settings': True,
u'admin_users': True,
u'access_token': u'oBHMEjGMYGhoCbdBXyShcIOzy4O1uCQ4$$bubxdOeviXLEXbj0Jy56wyORHFKQDF6C',
u'apicp': u'sharefile.com',
u'expires_in': 28800,
u'web_app_login': True,
u'token_type': u'bearer',
u'admin_accounts': True,
u'subdomain': u'cumberlandcg',
u'modify_files_folders': True,
u'appcp': u'sharefile.com',
u'refresh_token': u'oBHMEjGMYGhoCbdBXyShcIOzy4O1uCQ4$$xEdoERkufbfmYY8UhFGxoCBiKBCOLaCdMxcuKzC9'
         }"""
